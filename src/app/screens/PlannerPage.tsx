...
export default function PlannerPage() {
  ...
  return (
    <div className="min-h-full bg-white pb-10">
      <div className="mb-6 rounded-b-3xl bg-gradient-to-br from-[#1E3A8A] to-[#3B82F6] px-5 pb-6 pt-[max(3rem,env(safe-area-inset-top))]">
        <h1 className="text-2xl text-white">Plan Your Trip</h1>
        <p className="mt-1 text-sm text-white/80">Create a smart itinerary in minutes</p>
      </div>
